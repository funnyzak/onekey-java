package com.github.funnyzak.onekey.web.controller.console.base;
...
import com.github.funnyzak.onekey.bean.resource.enums.WatermarkPosition;
...
import com.github.funnyzak.onekey.common.id.IdCardUtils;
...
public class AppController extends ConsoleBaseController {
    ...
    public Result allEnum() {
        return Result.success().addData(JsonConstants.LIST_NAME
                , ReflectionUtils
                        .allEnum("com.github.funnyzak.onekey")
