package com.github.funnyzak.web.controller.wx.mp;
...
import com.github.funnyzak.biz.config.wx.mp.WxMpConfiguration;
...
//        menu.getButtons().add(button2);
        ...
        if (servletRequestAttributes != null) {
            ...
            String url = WxMpConfiguration.getMpServices().get(appid)
                    .getOAuth2Service().buildAuthorizationUrl(
                            String.format("%s://%s/wechat/redirect/%s/greet", requestURL.getProtocol(), requestURL.getHost(), appid),
