...
import com.github.funnyzak.onekey.biz.core.lib.CheckObject;
 ...
 * @description RedisCheckDB
 */
public class RedisCheckDB implements CheckObject {
    /**
     ...
     * Logging object.
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(RedisCheckDB.class);
     ...
     * @since v0.3.1
     */
    public RedisCheckDB(InetAddress serverIp, int port, String password, int dbIndex) {
