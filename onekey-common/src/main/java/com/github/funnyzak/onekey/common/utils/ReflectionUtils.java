...
public class ReflectionUtils {
    ...
    public static Reflections reflections(String... basePackages) {
        return new Reflections(new ConfigurationBuilder().forPackages(basePackages == null ? new String[]{"com.github.funnyzak.onekey"} : basePackages).addScanners(new SubTypesScanner()).addScanners(new FieldAnnotationsScanner()));
    }
